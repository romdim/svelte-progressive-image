...
describe('Image', () => {
  describe('includes a source tag', () => {
    it('with default attributes', () => {
      ...
      expect(source).toHaveAttribute('sizes', '(max-width: 375px) 338px, (max-width: 576px) 518px, (max-width: 768px) 691px, (max-width: 992px) 893px, 1280px');
    ...
    describe('with proper sizes', () => {
      ...
      it('when different largestImageSize', () => {
        ...
        const source = getByTestId('source');
        expect(source).toHaveAttribute('sizes', '(max-width: 375px) 338px, (max-width: 576px) 518px, (max-width: 768px) 691px, (max-width: 992px) 893px, 1000px');
      })

      it('when null largestImageSize', () => {
        const { getByTestId } = render(Image, {largestImageSize: null});
        const source = getByTestId('source');
        expect(source).toHaveAttribute('sizes', '(max-width: 375px) 338px, (max-width: 576px) 518px, (max-width: 768px) 691px, (max-width: 992px) 893px');
      })
    });
  });
  ...
  describe('includes an img tag', () => {
    it('with default attributes', () => {
      ...
      expect(img).toHaveAttribute('sizes', '(max-width: 375px) 338px, (max-width: 576px) 518px, (max-width: 768px) 691px, (max-width: 992px) 893px, 1280px');
    ...
    describe('with proper sizes', () => {
      ...
      it('when different largestImageSize', () => {
        const { getByTestId } = render(Image, {largestImageSize: 1000});
        const img = getByTestId('img');
        expect(img).toHaveAttribute('sizes', '(max-width: 375px) 338px, (max-width: 576px) 518px, (max-width: 768px) 691px, (max-width: 992px) 893px, 1000px');
      })

      it('when null largestImageSize', () => {
        const { getByTestId } = render(Image, {largestImageSize: null});
        const img = getByTestId('img');
        expect(img).toHaveAttribute('sizes', '(max-width: 375px) 338px, (max-width: 576px) 518px, (max-width: 768px) 691px, (max-width: 992px) 893px');
      })
    });
  });
});